...
public class BlockEnrichedpile extends Block{
	
	private static final AxisAlignedBB PILE = new AxisAlignedBB(0, 0, 0, 1, .0625 * 6, 1);
	
	public BlockEnrichedpile() {
		super(Material.SAND);
		setUnlocalizedName(Reference.MagitechBlocks.ENCRICHEDPILE.getUnlocalizedName());
		setRegistryName(Reference.MagitechBlocks.ENCRICHEDPILE.getRegistryName());
