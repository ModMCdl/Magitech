...
public class BlockBloodpile extends Block{
	
	private static final AxisAlignedBB PILE = new AxisAlignedBB(0, 0, 0, 1, .0625 * 6, 1);
	
	public BlockBloodpile() {
		super(Material.SAND);
		setUnlocalizedName(Reference.MagitechBlocks.BLOODPILE.getUnlocalizedName());
		setRegistryName(Reference.MagitechBlocks.BLOODPILE.getRegistryName());
