...
public class BlockMysticalpile extends Block{
	
	private static final AxisAlignedBB PILE = new AxisAlignedBB(0, 0, 0, 1, .0625 * 6, 1);
	
	public BlockMysticalpile() {
		super(Material.SAND);
		setUnlocalizedName(Reference.MagitechBlocks.MYSTICALPILE.getUnlocalizedName());
		setRegistryName(Reference.MagitechBlocks.MYSTICALPILE.getRegistryName());
