...
public class BlockTearpile extends Block{
	
	private static final AxisAlignedBB PILE = new AxisAlignedBB(0, 0, 0, 1, .0625 * 6, 1);
	
	public BlockTearpile() {
		super(Material.SAND);
		setUnlocalizedName(Reference.MagitechBlocks.TEARPILE.getUnlocalizedName());
		setRegistryName(Reference.MagitechBlocks.TEARPILE.getRegistryName());
