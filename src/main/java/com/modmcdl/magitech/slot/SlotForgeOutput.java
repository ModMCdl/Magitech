...
public class SlotForgeOutput extends Slot{
	...
	public SlotForgeOutput(EntityPlayer player, IInventory inventoryIn, int index, int xPosition, int yPosition) {
	...
	protected void onCrafting(ItemStack stack) {
		...
		if(!this.player.world.isRemote) {
			...
			float f = ForgeRecipe.instance().getForgeExperience(stack);
