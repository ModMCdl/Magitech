...
public class TileEntityForge extends TileEntity implements IInventory, ITickable{
	...
	public String getName() {
		return this.hasCustomName() ? this.customName : "Thaumic Forge";
	}
...
++this.cookTime;
	...
	private boolean canSmelt() {
		if(((ItemStack)this.inventory.get(0)).isEmpty() || ((ItemStack)this.inventory.get(1)).isEmpty())
			...
			ItemStack result = ForgeRecipe.instance().getForgeResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));
	...
	public void smeltItem() {
		if(this.canSmelt()) {
			...
			ItemStack result = ForgeRecipe.instance().getForgeResult(input1, input2);
			ItemStack output = (ItemStack)this.inventory.get(3);
	...
	public static int getItemBurnTime(ItemStack fuel) {
		if(fuel.isEmpty())
			...
			if (item == ModItems.crystal) return 2400;
